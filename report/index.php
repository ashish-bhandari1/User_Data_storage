<?php
	...
	$totalPruches = "SELECT SUM(amount) AS 'sumTotal' FROM customer_data WHERE phone = '$phone'";
	$totalQty = "SELECT SUM(qty) AS 'qtyTotal' FROM customer_data WHERE phone = '$phone'" ;
...
<body>
    ...
    <div class="container">
        <div class="dataWrapper container">
            <h4>Total purches made by <?php echo $phone; ?> </h4>
        ...
        <form class="form-horizontal" action="daily.php" method="post" id="contact_form">
		
		<h4 style="font-size:16px">Pick a date to view daily report made by <?php echo $phone; ?> </h4>
